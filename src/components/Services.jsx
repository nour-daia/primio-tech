...
export default function Services() {
  ...
  return (
    <section id="services" className="relative overflow-x-hidden bg-blue-black/40 py-16 md:py-28">
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.article
                ...
                whileHover={{ y: -4 }}
                className="group min-w-0 rounded-2xl border border-border bg-gradient-to-b from-slate/60 to-navy/80 p-5 text-start transition-all duration-300 hover:border-electric/40 hover:shadow-lg hover:shadow-electric/10 sm:p-6"
              >
